...
// StatCard component - refined design
const StatCard = ({ value, label, suffix = '' }) => {
  ...
  return (
    <div ref={ref} className="group bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-100/50 hover:bg-white hover:shadow-xl hover:scale-105 transition-all duration-500">
      <div className="text-5xl font-light text-gray-900 mb-3 tracking-tight">
...
// FeatureCard component - refined design
const FeatureCard = ({ feature, index }) => {
  ...
  return (
    <div
      ref={ref}
      className={`group bg-white rounded-2xl p-8 border border-gray-100 hover:border-blue-100 hover:shadow-2xl transition-all duration-500 ${
...
function App() {
  ...
  const [currentPage, setCurrentPage] = useState('home') // 'home' or 'user-service'
  const { isAuthenticated, user } = useAuth()

  // Scroll animations with throttling
  useEffect(() => {
    let ticking = false
  ...
  const features = useMemo(() => [
    {
      ...
      description: 'Trouvez instantanément les meilleurs trajets disponibles entre Temara, Rabat et Salé grâce à notre algorithme de recherche avancé.'
    },
    {
      icon: Calendar,
      title: 'Réservation Intuitive',
      description: 'Réservez votre place en quelques instants. Interface simple et épurée pour une expérience utilisateur optimale.'
    },
    {
      icon: Navigation,
      title: 'Suivi en Direct',
      description: 'Localisez votre bus en temps réel avec précision GPS. Arrivée estimée et itinéraire actualisé en continu.'
    },
    {
      icon: Clock,
      title: 'Horaires Actualisés',
      description: 'Consultez les horaires en temps réel de tous les trajets. Planification optimisée de vos déplacements quotidiens.'
    },
    {
      icon: Users,
      title: 'Abonnements Flexibles',
      description: 'Formules mensuelles et annuelles personnalisées. Économies substantielles et gestion simplifiée.'
    },
    {
      icon: Smartphone,
      title: 'Notifications Intelligentes',
      description: 'Alertes personnalisées sur les retards, modifications d\'horaires et arrivées imminentes de votre bus.'
    }
  ], [])
  ...
  // If on user service page, show it
  if (currentPage === 'user-service') {
    return (
      <div className="min-h-screen">
        <UserService onBack={() => setCurrentPage('home')} />
      </div>
    )
  }
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {['home', 'features', 'about', 'contact'].map((section) => (
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full transition-all duration-300 text-sm font-medium tracking-wide ${
            ...
            <Button 
              onClick={() => setCurrentPage('user-service')}
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-16 leading-relaxed font-light">
              Recherchez, réservez et suivez vos bus en temps réel. Une expérience moderne et fluide pour vos déplacements quotidiens dans la région{' '}
              <span className="font-semibold text-blue-600">Temara · Rabat · Salé</span>
            </p>
          </div>
          ...
          <Card className="max-w-4xl mx-auto bg-white/80 backdrop-blur-xl border border-gray-200/50 shadow-2xl rounded-3xl overflow-hidden">
            <CardHeader className="text-center pb-6 pt-10 px-10">
              <CardTitle className="text-3xl font-light text-gray-900 tracking-tight mb-3">
                Rechercher un trajet
              </CardTitle>
              <CardDescription className="text-gray-600 text-base font-light">
                Trouvez le bus qui correspond parfaitement à vos besoins
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      placeholder="Temara, Rabat, Salé..."
                      value={from}
                      onChange={(e) => setFrom(e.target.value)}
                      className="pl-12 bg-gray-50/50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 h-14 rounded-xl font-light transition-all duration-300"
                    />
                  </div>
                </div>
                <div className="space-y-3">
      ...
      <section id="features" className="py-24 px-6 lg:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-light mb-6 text-gray-900 tracking-tight">
              Fonctionnalités <span className="font-semibold">Principales</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
              Découvrez l'ensemble de nos outils conçus pour simplifier et optimiser vos déplacements urbains
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl font-light mb-6 text-gray-900 tracking-tight">
                À propos d'<span className="font-semibold">UrbanMove</span>
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed mb-10 font-light">
                UrbanMoveMS est une plateforme de gestion de transport urbain fondée sur une architecture microservices moderne. Notre système assure une gestion efficace et sécurisée des utilisateurs, trajets, billetterie, abonnements et notifications en temps réel.
              </p>
      ...
      <section id="contact" className="py-24 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-14 shadow-2xl border border-white/20">
            <h2 className="text-4xl sm:text-5xl font-light mb-5 text-gray-900 tracking-tight">
              Prêt à <span className="font-semibold">commencer</span> ?
            </h2>
            <p className="text-xl text-gray-600 mb-10 font-light leading-relaxed">
              Rejoignez des milliers d'utilisateurs qui simplifient leurs déplacements avec UrbanMove
            </p>
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              <Button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium px-10 py-7 h-auto rounded-xl shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 hover:scale-105 transition-all duration-300">
                Créer un compte
                <ArrowRight className="w-5 h-5 ml-3" />
              </Button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed font-light">
                Votre solution de transport urbain pour la région Temara-Rabat-Salé
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-sm text-gray-500 font-light">
              © 2024 UrbanMoveMS. Tous droits réservés.
            </p>
          </div>
        </div>
      </footer>
